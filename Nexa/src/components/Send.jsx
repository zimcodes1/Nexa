...
function Send({ onClose }){
    ...
    return(
        <div ref={componentRef} className="max-md:fixed max-md:w-[90%] max-md:ml-[10%] max-md:rounded-none max-md:px-10 max-md:pt-10 max-md:h-full z-10 max-sm:w-full max-sm:h-[80%] max-sm:fixed max-sm:bottom-0 max-sm:rounded-b-none max-sm:bg-[#141414] max-sm:shadow-md shadow-white flex w-[30%] h-[700px] bg-gradient-to-b from-transparent to-[#cccccc11] max-md:bg-[#111] rounded-4xl mr-5 p-5 flex-wrap backdrop-blur-sm">
